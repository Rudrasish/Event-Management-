<?php
	...
	if(isset($_POST['previousbtn']))
    {
	  ...
	  exit();
		...
		$sql = "INSERT INTO event_table (`user_id`,`name`,`email`,`phone`,`r_type`,`event`,`ticket`,`unique_id`,`seat`,`image`) VALUES ('".$user_id."','".$name."','".$email."','".$phone."','".$r_type."','".$event."','".$ticket."','".$unique_id."','".$seat."','".$image."')";
