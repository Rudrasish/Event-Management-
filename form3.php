...
@media screen and (max-width: 600px) {
  .col-25, .col-75, .col-dropdown input[type=submit] {
    width: 100%;
    margin-top: 0;
  }
}
...
<div class="container" >
  ...
  <div class="row">
    <center><h1>Technical Event</h1></center><br><br>
    <div class="col-25">
  ...
  <div class="row">
    ...
    <div class="col-75">
      ...
      <select id="event" name="event">
        <option value="robotics-robo ranger">ROBOTICS (Robo Ranger)</option>
        <option value="robotics-robo soccer">ROBOTICS (Robo Soccer)</option>
        <option value="robotics-line follower">ROBOTICS (Line Follower)</option>
        <option value="gaming-need for speed">GAMING (Need For Speed)</option>
        <option value="gaming-pubg">GAMING (PUBG)</option>
        <option value="gaming-fifa 19">GAMING (Fifa 19)</option>
        <option value="build 2 rule">Build 2 Rule</option>
        <option value="mech tech">Mech Tech</option>
        <option value="code it-code war">CODE IT (Code War)</option>
        <option value="code it-blind coding">CODE IT (Blind Coding)</option>
        <option value="code it-debugging">CODE IT (Debugging)</option>
      </select>
    </div-->
  ...
  <div class="row">
    <div class="col-25">
      <label for="ticket">Number of Tickets<center> (Rs.150/ticket)</center></label>
    </div>
    <div class="col-75">
...
<!--script src="//code.tidio.co/denfrnuu1go0xeutlzcn653gciijv2zv.js" async></script-->
